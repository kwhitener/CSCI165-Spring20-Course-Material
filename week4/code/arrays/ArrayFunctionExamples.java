...
public class ArrayFunctionExamples {
	...
	/* returns the mean of the array
	   This method has no array side effects, it simply uses the elements in the array
	   to compute and return a new value
	*/
	...
	/* swaps array elements i and j
	   This method has the side effect of changing the position of items in the array
	   it is a void method, and does not return anything
	   The int arguments are copies of the orginal values
	*/
	...
	*/
	...
	/* prints a one-dimensional array and its length
		This method has no array side effects and does not return anything
		It simply prints the array in a nice format
	*/
	...
	/* prints a two-dimensional array and its length
		This method has no array side effects and does not return anything
		It simply prints the array in a nice format
	*/
    public static void printArray(double[][] a){
	...
	/* reads a two-dimensional array from standard input
		This method creates a new array and fills it from user input
		The array is the returned
	*/
